...
return [
    ...
    'menuitem' => [
        ...
        'display_tab' => 'Näkyvyys',
        'hidden' => 'Piilotettu',
        'hidden_comment' => 'Piilota tämän valikon kohde näkyvistä käyttäjän näkymässä.',
        'attributes_tab' => 'Attribuutti',
        'code' => 'Koodi',
        'code_comment' => 'Syötä valikkokohten koodi jos haluat käyttää sitä API:n kanssa.',
        'css_class' => 'CSS-luokka',
        'css_class_comment' => 'Anna tämän valikon kohteelle oma CSS-luokka ulkoasua varten.',
    ...
    'content' => [
        'menu_label' => 'Sisältö',
        'saved' => 'Sisältö tallennettu onnistuneesti.',
    ...
    'object' => [
        ...
        'unauthorized_type' => 'Sinulla ei ole oikeuksia muokata kohdetta :type',
    ...
    'component' => [
        ...
        'static_page_child_layout_name' => 'Alasivun ulkoasu',
        'static_page_child_layout_description' => 'Oletusulkoasu kaikille uusille alasivuille',
        ...
        'static_breadcrumbs_name' => 'Staattinen murupolku',
